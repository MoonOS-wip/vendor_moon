...
- moonremote:      Add git remote for matching AOSP repository.
...
function moonremote()
{
    ...
    git remote add moon https://android.googlesource.com/$PFX$PROJECT
...
function repopick() {
    T=$(gettop)
    $T/vendor/moon/build/tools/repopick.py $@
}
